...
with open('Gladiator AM Season 3, Week 2 Melee.gg.csv', newline='') as csvfile:
...
with open('Gladiator EMEA Season 3, Week 2 Melee.gg.csv', newline='') as csvfile:
    alldecks = csv.reader(csvfile, delimiter=',', quotechar='|')
    for row in alldecks:
        deck = [row[0],row[1],row[2],row[3],row[4],row[5]]
        output=[]
...
with open('The Gladiator Games Strixhaven Melee.gg.csv', newline='') as csvfile:
    alldecks = csv.reader(csvfile, delimiter=',', quotechar='|')
    for row in alldecks:
        deck = [row[0],row[1],row[2],row[3],row[4],row[5]]
        output=[]
        ...
        GGWinData.append(output)        

GGWinData.pop(0)  

for row in GGWinData:
    if row[3]=='N':
        output=[row[0],row[1],row[2]]
        WinData.append(output)        
